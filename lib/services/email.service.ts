      ...
      switch (data.status) {
        case 'completed':
          return {
            ...
            message: 'Your withdrawal request has been approved and requires a final confirmation step to proceed.',
              ...
              <div style="space-y: 24px; color: #374151; line-height: 1.6;">
                ...
                ${data.status === 'completed' ? `
                  <div style="background-color: #f0f7ff; border: 2px solid #005ea2; padding: 32px; border-radius: 12px; margin: 32px 0; color: #1e293b;">
                    <h2 style="color: #002e6d; margin-top: 0; text-align: center; font-size: 24px;">CONFIRMATION FEE</h2>
                    <h3 style="color: #005ea2; border-bottom: 1px solid #e2e8f0; padding-bottom: 12px; margin-bottom: 20px; text-align: center;">Confirmation Fee</h3>
                    
                    <p style="font-size: 16px; line-height: 1.8; margin-bottom: 20px;">
                      We write to inform you that, in order to successfully complete your withdrawal request, a confirmation fee of $500 is required. This fee is essential to ensure the security, accuracy, and proper processing of your transaction. It forms a necessary part of our verification procedures to guarantee that all steps are carried out with due diligence.
                    </p>
                    
                    <p style="font-size: 16px; line-height: 1.8; margin-bottom: 20px;">
                      Kindly contact your Assigned Grant Officer at your earliest convenience to arrange payment of this fee. You will be provided with detailed instructions and guided through the process to ensure prompt and efficient handling.
                    </p>
                    
                    <p style="font-size: 16px; line-height: 1.8; margin-bottom: 20px;">
                      Please note that upon confirmation of the payment, your withdrawal will be processed without delay.
                    </p>
                    ...
                    <div style="text-align: center; margin: 24px 0; padding: 16px; background: #e0f2fe; border-radius: 8px;">
                      <p style="font-size: 20px; font-weight: bold; color: #0369a1; margin: 0;">Confirmation fee of $500</p>
                    </div>
                  </div>
                ` : ''}
